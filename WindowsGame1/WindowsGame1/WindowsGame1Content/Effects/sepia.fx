...
SScenePixelToFrame ShadowedScenePixelShader(SSceneVertexToPixel PSIn)
{
	...
	float4 baseColor = tex2D(TextureSampler, PSIn.TexCoords);
		Output.Color = baseColor*(diffuseLightingFactor + xAmbient);
	float4 outputColor = Output.Color;
	outputColor.r = (Output.Color.r * 0.393) + (Output.Color.g * 0.769) + (Output.Color.b * 0.189);
	outputColor.g = (Output.Color.r * 0.349) + (Output.Color.g * 0.686) + (Output.Color.b * 0.168);
	outputColor.b = (Output.Color.r * 0.272) + (Output.Color.g * 0.534) + (Output.Color.b * 0.131);
